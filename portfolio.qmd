...
::: {.project-card}
### [<i class="bi bi-github"></i></i> Computational Attention Model](https://github.com/dgraetz/state_checking_attentional_allocation_model)

Check out the development of the computational model of rational attentional decision-making between a primary rewarding task and checking on hidden states that would incur losses if left unchecked [here](https://htmlpreview.github.io/?https://github.com/dgraetz/state_checking_attentional_allocation_model/blob/main/final_model.html).
:::
...
::: {.project-card}
### [<i class="bi bi-github"></i> Analysis Code — Multilevel Stability–Flexibility Project](https://github.com/dgraetz/stability_flexibility)

Project in collaboration with Neha Nagarkar and Sophia Angleton. R analysis scripts and models for the three-level stability/flexibility tradeoff project. Includes experimental, within-subject, and individual differences analyses testing whether cognitive control exhibits a fundamental tradeoff between stability and flexibility. Check out a rendered html version of the analysis [here](https://htmlpreview.github.io/?https://github.com/dgraetz/stability_flexibility/blob/main/dominik/AlternateRuns.html) and [here](https://htmlpreview.github.io/?https://github.com/dgraetz/stability_flexibility/blob/main/dominik/AlternateCues.html).
:::
